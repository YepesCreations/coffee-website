...
// Reusable function to add a click event listener. It ensures the element exists before adding the event listener.
...
// Function to hide the mobile menu. It removes the 'show-menu' class from the menu.
const hideMenu = () => {
